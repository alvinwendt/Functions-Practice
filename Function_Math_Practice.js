...
// Any time you want to run your code, go to the terminal *(make sure you are in the `functions-math` directory)* and type `node main.js`. You will only see output if you have a `console.log()` statement somewhere.
